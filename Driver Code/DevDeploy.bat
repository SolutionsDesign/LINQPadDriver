...
xcopy /i/y *.dll "C:\ProgramData\LINQPad\Drivers\DataContext\3.5\SD.LLBLGen.Pro.LINQPadDriver58 (b094696bc21c000a)"
xcopy /i/y *.pdb "C:\ProgramData\LINQPad\Drivers\DataContext\3.5\SD.LLBLGen.Pro.LINQPadDriver58 (b094696bc21c000a)"
pause